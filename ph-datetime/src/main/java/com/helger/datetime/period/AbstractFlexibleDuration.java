...
/**
 * Abstract base implementation for {@link IFlexibleDuration}.
 *
 ...
 */
@NotThreadSafe
public abstract class AbstractFlexibleDuration <DATATYPE> implements IFlexibleDuration <DATATYPE>
{
  private DATATYPE m_aStart;
  private DATATYPE m_aEnd;

  public AbstractFlexibleDuration (@Nullable final DATATYPE aStart, @Nullable final DATATYPE aEnd)
  {
    setStart (aStart);
    setEnd (aEnd);
  }
  ...
  public boolean equals (final Object o)
  {
    ...
    if (o == null || !getClass ().equals (o.getClass ()))
      return false;
    final AbstractFlexibleDuration <?> rhs = (AbstractFlexibleDuration <?>) o;
